...
ug_load_script("xbraid_time_stepper.lua") -- load neccessary XBraid lua interfaces
...
if (doTransient) then
    ...
    elseif (ARGS.LimexNStages == 1) then
        ...
        braid = xbraid_util.CreateBraidIntegrator(braid_desc,space_time_communicator,logging,vtk_scriptor,domainDisc,lsolver)
        v = ustart:clone()
