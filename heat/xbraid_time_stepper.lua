...
function xbraid_util.set_relax_type(braid, p_mgrit_relax_type)
    ...
    elseif p_mgrit_relax_type == "F-FCF" then
        braid:set_n_relax(-1, 1)
        braid:set_n_relax(0, 0)
...
function xbraid_util.CreateBraidIntegrator(desc, communicator, logging, scriptor,domainDisc,solver)
    -- creating app
    app = BraidTimeStepper()
    -- set app base values
    app:set_domain(domainDisc)
...
function xbraid_util.CreateBraidStepper(desc, communicator, logging, scriptor,domainDisc,solver)
    -- creating app
    app = BraidTimeStepper()
    -- set app base values
    app:set_domain(domainDisc)
