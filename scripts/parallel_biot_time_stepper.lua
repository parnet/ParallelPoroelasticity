...
XARGS = {
    ...
    p_relaxation = util.GetParam("--relax", "FCF", "relaxation type FCF, F-FCF or F-relaxation"),
...
if (doTransient) then
    ...
    elseif (ARGS.LimexNStages == 1) then
        ...
        braid = xbraid_util.CreateBraidIntegrator(braid_desc,space_time_communicator,logging, vtk_scriptor)
        v = u_start:clone()
