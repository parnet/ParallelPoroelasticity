...
braid_desc = {
    type = "integrator",
    time = { t_0 = startTime, t_end = endTime, n = 32},--math.ceil((endTime-startTime)/dt) },
...
if (doTransient) then
    ...
    elseif (ARGS.LimexNStages == 1) then
        ...
        braid = xbraid_util.CreateBraidIntegrator(braid_desc,space_time_communicator,logging,fine_integrator, coarse_integrator)
        v = u_start:clone()
